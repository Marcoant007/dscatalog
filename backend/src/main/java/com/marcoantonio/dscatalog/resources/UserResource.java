...
public class UserResource {
    ...
    @PostMapping
    public ResponseEntity<UserDTO> created(@RequestBody UserInsertDTO userDTO){
    ...
    @PutMapping(value = "/{id}")
    public ResponseEntity<UserDTO> updated(@PathVariable Long id, @RequestBody UserDTO userDTO){
